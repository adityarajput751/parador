                ...
                <div className="row">
                    <div className="col col-lg-7 col-md-8 col-sm-12 col-12">
                        <div className="contact-intro">
                            <ul>
                                <li><i className="fi flaticon-email"></i> lapiazza@gmail.com</li>
                                <li><i className="fi flaticon-phone-call"></i> +888 (123) 123456</li>
                                <li><i className="fi ti-location-pin"></i> DRC</li>
                            </ul>
                        </div>
                    </div>
